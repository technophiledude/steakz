...
router.get('/kpi', async (_req, res) => {
    ...
    const [thisMonthSales, lastMonthSales, last30Sales, activeBranches, totalStaff, unreadAlerts, lowStockRaw,] = await Promise.all([
    ...
    const lowStockCount = lowStockRaw
...
router.get('/analytics', async (req, res) => {
    ...
    const lowStockAlerts = stockAlerts
